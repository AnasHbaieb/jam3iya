    ...
    <div className="min-h-screen flex flex-col" dir="rtl">
      <main className="flex-grow flex items-center justify-center">
        <div className="container mx-auto p-4">
          <h1 className="text-3xl font-bold text-amber-500 text-center mb-6">استمارة تطوع</h1>

          <form onSubmit={handleSubmit} className="p-8 rounded-lg shadow-md max-w-2xl mx-auto bg-gray-100">
