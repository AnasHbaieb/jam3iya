      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/admin/carousel" className="block">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border border-green-200">
              <h2 className="text-xl font-semibold mb-2 text-green-800">إدارة صور الواجهة</h2>
              <p className="text-amber-600"> (caroucel)إدارة صور الواجهة </p>
              <div className="mt-4 text-green-600 font-medium"> إدارة صور الواجهة →</div>
            </div>
          </Link>
        </div>
