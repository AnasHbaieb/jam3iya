...
export default function AddProductPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.category) {
      setError('يجب اختيار فئة للمشروع');
      return false;
    }
    if (!imageFile) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (secondaryImageFile) formDataToSend.append('secondaryImage', secondaryImageFile);
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'فشل في إضافة المشروع');
      }
      ...
      setError(err instanceof Error ? err.message : 'حدث خطأ غير متوقع أثناء إضافة المشروع');
    } finally {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto p-6">
        <div className="flex justify-between items-start mb-6">
          <h1 className="text-3xl font-bold text-amber-600 mb-2">إضافة مشروع جديد</h1>
          ...
          {success && (
            <div className="bg-green-50 border-l-4 border-green-500 p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-green-700">تمت إضافة المشروع بنجاح!</p>
                </div>
              </div>
            </div>
          )}
